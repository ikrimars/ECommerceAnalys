...
st.write(f"Average delivery time: {rata_rata_pengiriman:.2f} days")
...
with tabs[1]:
    ...
    plt.yticks(fontsize=10)
    st.pyplot(plt)
    st.markdown('Terdapat 10 produk paling mahal dapat dilihat pada gambar di atas ini. Pada 10 produk tersebut terdapat produk yang paling mahal yaitu utilidades domesticas sebesar 6735.0 USD')

st.header("Distribusi tipe pembayaran untuk order")
# st.image("Distribusipayment.jpg")
